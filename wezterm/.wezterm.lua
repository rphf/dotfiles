...
wezterm.on("launch_zenmaid_workspace", function()
  ...
  local _, mobile_pane_1 =
    zenmaid_window:spawn_tab({ cwd = project_dir .. "/zenmaid-mobile" })
  ...
  zenmaid_window
    :gui_window()
    :perform_action(wezterm.action.ActivateTab(0), webapp_pane_1)
...
wezterm.on("gui-startup", function()
  local _, _, default_window =
    wezterm.mux.spawn_window({ workspace = "default" })
